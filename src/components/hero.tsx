...
const Hero = () => {
  ...
  return (
    <section className="container relative mx-auto px-4 py-24 sm:px-6 lg:px-8">
      ...
      <div className="absolute -left-20 top-0 h-72 w-72 rounded-full bg-primary/5 blur-3xl"></div>
      <div className="absolute -right-20 bottom-0 h-72 w-72 rounded-full bg-primary/5 blur-3xl"></div>
      ...
      <div className="relative">
        ...
        <div className="mb-12 text-center">
          <h1 className="group relative mb-6 inline-flex flex-col items-center text-5xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            ...
            <Link
              href="/contact"
              className="relative inline-flex cursor-pointer select-none items-center gap-2 rounded-full bg-primary/10 px-6 py-2 text-lg font-medium tracking-wider text-primary transition-all duration-300 hover:-translate-y-1 hover:bg-primary/20 hover:shadow-lg"
            >
              Available for hire
          ...
          <div className="relative mx-auto max-w-3xl select-none overflow-hidden rounded-2xl bg-gradient-to-br from-primary/5 via-primary/10 to-transparent p-8 backdrop-blur-sm">
            <div className="absolute -right-8 -top-8 h-32 w-32 rotate-12 bg-primary/10 blur-3xl"></div>
            <h2 className="bg-gradient-to-r from-slate-800 via-primary to-slate-800 bg-clip-text text-3xl font-bold text-transparent">
        ...
        <div className="mb-12 grid gap-6 sm:grid-cols-2">
          <div className="group select-none rounded-2xl bg-gradient-to-br from-white via-primary/5 to-transparent p-6 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
        ...
        {/* CTA Section */}
        <div className="mb-12">
          <div className="group relative select-none overflow-hidden rounded-2xl bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 p-6 text-center transition-all duration-300 hover:shadow-lg">
            <div className="absolute inset-0 bg-primary/5 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
            <p className="relative text-lg font-medium text-primary">
