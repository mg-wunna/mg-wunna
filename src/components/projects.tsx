    ...
    <div className="container mx-auto mb-32 px-4 sm:px-6 lg:px-8">
      <div className="mb-12 text-center">
        <h2 className="relative mb-4 inline-block text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
          Featured Projects
          <div className="absolute -right-6 -top-6 h-12 w-12 rotate-12 rounded-lg bg-primary/10 blur-xl"></div>
          <div className="absolute -bottom-6 -left-6 h-12 w-12 -rotate-12 rounded-lg bg-primary/10 blur-xl"></div>
        </h2>
        <p className="mx-auto max-w-2xl text-lg text-gray-600">
          Explore a collection of my recent work showcasing web development and
          design expertise
        </p>
        <div className="mx-auto mt-4 h-1 w-20 rounded bg-gradient-to-r from-primary/5 via-primary to-primary/5"></div>
      </div>
