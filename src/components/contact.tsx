...
const Contact = () => {
  ...
  return (
    <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      {/* Decorative elements */}
      <div className="absolute -left-4 top-0 h-64 w-64 rounded-full bg-orange-100/50 blur-3xl" />
      <div className="absolute -right-4 bottom-0 h-64 w-64 rounded-full bg-blue-100/50 blur-3xl" />
      ...
      <div className="relative">
        ...
        <div className="grid gap-12">
          ...
          <div className="flex flex-row gap-10">
            <div>
              <h1 className="mb-4 bg-gradient-to-r from-orange-500 to-blue-500 bg-clip-text text-4xl font-bold text-transparent">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-600">mgwunna.mw@icloud.com</p>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-600">+95 9 777 177 317</p>
                </div>
              </Link>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white p-8 shadow-xl">
            ...
            >
              ...
              <button
                type="submit"
                className={twMerge(
                  'group relative w-full rounded-lg bg-white px-8 py-4',
                  ...
                  <span className="relative z-10 flex items-center gap-2">
                    {isLoading ? (
                      ...
                      <>
                        ...
                        <span className="relative z-10 flex h-6 w-6 items-center justify-center rounded-full bg-orange-100 group-hover:bg-white/20">
                          <svg
                            className="h-4 w-4 text-orange-500 transition-all duration-500 group-hover:text-white"
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
                          >
