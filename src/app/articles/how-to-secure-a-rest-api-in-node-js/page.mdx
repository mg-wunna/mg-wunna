...
export const article = {
  ...
  description:
    'In this blog, we will discuss how to secure a REST API in Node.js. This is a comprehensive guide that covers various aspects of securing a REST API, including authentication, authorization, input validation, and more.',
}
...
<div style={{ width: '100%' }}>
  <Image
    src="https://placehold.co/1200x600/ef4444/ffffff.png?font=lato&text=Secure+REST+API+Node.js"
    alt="Cover"
    width={1200}
    height={600}
